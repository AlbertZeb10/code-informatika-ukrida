$(this).ready(function () {
  ...
  $(this).ready(function () {
    $(document).on("click", "#btnSave", function () {
      ...
      $.ajax({
        type: "POST",
        url: "_php/writeFiersa.php",
        data: dataSend,
        dataType: "html",
        success: function (result) {
          Swal.fire({
            icon: "success",
            title: "Music Fiersa Besari Berhasil Ditambahkan",
            text: "Music Fiersa Besari Berhasil Ditambahkan!",
          }).then(function () {
            document.location.href = "AdmFiersa.php";
          });
        },
      });
    });
