$(this).ready(function () {
  ...
  $(this).ready(function () {
    $(document).on("click", "#btnSave", function () {
      ...
      $.ajax({
        type: "POST",
        url: "_php/writeAndmesh.php",
        data: dataSend,
        dataType: "html",
        success: function (result) {
          Swal.fire({
            icon: "success",
            title: "Music Justin Bieber Berhasil Ditambahkan",
            text: "Music Justin Bieber Berhasil Ditambahkan!",
          }).then(function () {
            document.location.href = "AdmJustin.php";
          });
        },
      });
    });
