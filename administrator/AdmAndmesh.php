...
<html translate="no">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
        <script src="JavaScriptAdm/AdmAndmesh.js"></script>
        <title>MusicGo</title>
    </head>
    <body class="bg-secondary">
        <?php include('admNavbar.php') ?>
        <div class="container">
            <h3 class="text-center mt-3">List Music Andmesh</h3>
            <!-- Button trigger modal -->
            <button id="btnNew" type="button" class="btn btn-primary" data-bs-toogle="modal">
                Add Andmesh Kamelang
            </button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTitle">Add Andmesh</h5>
